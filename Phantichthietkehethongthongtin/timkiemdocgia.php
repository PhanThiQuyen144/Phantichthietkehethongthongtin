...
<html lang="en">
  ...
  <body style="background-color:lightsteelblue">
      <div class="container">
        ...
        <div class="row">
            <div class="col-md-6" style=" justify-content: center; margin-top:40px">
                <div class="form-group">
                  <label for="">Mã độc giả </label>
                  <input type="text" name="" id="" class="form-control" placeholder="" aria-describedby="helpId">
                  <!-- <small id="helpId" class="text-muted">Help text</small> -->
                  <a name="" id="" class="btn btn-primary" href="#" role="button"style=" justify-content: center; margin-top:40px">Tìm kiếm</a>
                </div>
            </div>
        </div>
      </div>
