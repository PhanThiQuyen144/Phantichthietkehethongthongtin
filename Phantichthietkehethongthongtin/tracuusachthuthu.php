...
<html lang="en">
  <head>
    <title>Tra cứu sách thủ thư</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavId">
                ...
                <form class="form-inline my-2 my-lg-0">
                   <!-- <input class="form-control mr-sm-2" type="text" placeholder="Search"> -->
                    <a href="index.php"> <button class="btn btn-success my-2 my-sm-0" type="submit" >Đăng xuất</button></a>
        ...
        <div class="row" style=" justify-content: center; margin-top:40px">
            <div class="col-md-4" >
                <div class="form-group">
                  <label for="">Mã đầu sách</label>
                  <input type="text" name="" id="" class="form-control" placeholder="" aria-describedby="helpId">
                  <!-- <small id="helpId" class="text-muted">Help text</small> -->
                  <a name="" id="" class="btn btn-primary" href="#" role="button" style="margin-top:40px">Xác nhận</a>
                </div>
            </div>
        </div>
      </div>
