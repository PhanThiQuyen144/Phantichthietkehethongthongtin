  ...
  <body style="background-color:lightsteelblue">
      <div class="container">
        ...
        <div class="row" style="margin-left:100px">
            <div class="col-md-4" style=" justify-content: center; margin-top:40px">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="" id="" class="form-control" placeholder="12/12/2000" aria-describedby="helpId">
                  <!-- <small id="helpId" class="text-muted">Help text</small> -->
                </div>
            </div>
            <div class="col-md-4"style=" justify-content: center; margin-top:40px">
                 <div class="form-group">
                  ...
                  <input type="text" name="" id="" class="form-control" placeholder="Nam" aria-describedby="helpId">
                  <!-- <small id="helpId" class="text-muted">Help text</small> -->
                </div>
                <div class="form-group">
                  <label for="">Mã lớp</label>
                  <input type="text" name="" id="" class="form-control" placeholder="60HT" aria-describedby="helpId">
                  <!-- <small id="helpId" class="text-muted">Help text</small> -->
                </div>
                <div class="form-group">
                  <label for="">Tài khoản</label>
                  <input type="text" name="" id="" class="form-control" placeholder="TK1" aria-describedby="helpId">
                  <!-- <small id="helpId" class="text-muted">Help text</small> -->
                </div>
